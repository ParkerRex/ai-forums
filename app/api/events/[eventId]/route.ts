...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
	try {
		...
		if (parsed.data.maxAttendees !== undefined)
			updateData.maxAttendees = parsed.data.maxAttendees;
		if (parsed.data.requiresRSVP !== undefined)
			updateData.requiresRSVP = parsed.data.requiresRSVP;
		if (parsed.data.streamUrl !== undefined)
			updateData.streamUrl = parsed.data.streamUrl;
		if (parsed.data.recordingUrl !== undefined)
			updateData.recordingUrl = parsed.data.recordingUrl;
		if (parsed.data.resources !== undefined)
			updateData.resources = parsed.data.resources;
