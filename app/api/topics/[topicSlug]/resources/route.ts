...
import { db } from "@/db";
import { topics, resources, members } from "@/db/schema";
...
export async function POST(request: NextRequest, context: RouteContext) {
	try {
		...
		const { title, description, url, type, difficulty, isPaid, isFree } =
			parsed.data;
