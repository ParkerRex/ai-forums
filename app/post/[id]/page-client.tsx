...
export default function PostPageClient({ params }: PageClientProps) {
  ...
  // Only create args object if we have a valid ID, otherwise undefined to skip query
  const queryArgs = hasValidPostId ? { postId: resolvedParams.id as Id<"posts"> } : undefined;
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Authenticated>
        ...
        <div className="mt-8">
          <CommentSection postId={queryArgs!.postId as Id<"posts">} />
        </div>
      </Authenticated>
