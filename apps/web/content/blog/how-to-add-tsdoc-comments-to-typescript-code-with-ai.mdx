...
### Before:
```typescript title="❌ Undocumented Code" showLineNumbers
...
### After:
```typescript title="✅ Well-Documented Code" showLineNumbers {1-10,16,19} /@param/ /@returns/ /@example/
/**
