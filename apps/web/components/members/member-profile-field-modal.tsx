...
export function MemberProfileFieldModal({
  memberId,
  field,
  currentValue,
  isOpen,
  ...
  const onSubmit = async (data: { value: string }) => {
    ...
    try {
      ...
      if (field === "bio") {
        ...
        updateData.linkYouTube =
          constructUrl(data.value, "youtube") || undefined;
      ...
      handleMutationSuccess(
        `${config.title.replace("Add ", "")} added successfully!`,
      );
      onClose();
    } catch (error) {
        ...
        <DialogContent className="max-w-md">
          ...
          >
            ...
            <div className="flex justify-end space-x-3 border-t pt-4">
              ...
              <Button
                type="submit"
                disabled={isSubmitting || !avatarUrl || !isOnline}
              >
                {isSubmitting ? (
