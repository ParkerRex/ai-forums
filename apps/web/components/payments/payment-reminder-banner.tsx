...
export function PaymentReminderBanner() {
  ...
  if (!subscriptionInfo.isActive) {
    return (
      <div className="relative w-full border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50 px-4 py-3 text-center text-sm font-medium text-gray-900">
        <Sparkles className="mr-2 inline-block h-4 w-4 text-blue-600" />
        <span>
          Join VAI Pro to unlock exclusive AI engineering content and connect
  ...
  return (
    <div className={bannerClasses}>
      ...
      <span>
        Your {subscriptionInfo.tierDisplay} subscription{" "}
