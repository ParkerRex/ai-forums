...
import { Search, Plus, ArrowUpIcon, BookOpen } from "lucide-react";
...
export default function TopicPageClient({ params }: TopicPageClientProps) {
  ...
  const [previousResources, setPreviousResources] = useState<Resource[] | null>(
    null,
  );
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="mb-2 flex items-center">
                <div className="bg-muted mr-3 h-12 w-12 animate-pulse rounded" />
                <div className="bg-muted h-9 w-64 animate-pulse rounded" />
              </div>
              {/* Description skeleton */}
              <div className="bg-muted mb-2 h-5 w-96 animate-pulse rounded" />
    ...
    return (
      <div className="mx-auto max-w-7xl px-4 py-6">
        <div className="py-12 text-center">
          ...
          <h1 className="mb-2 text-2xl font-bold">Topic Not Found</h1>
          <p className="text-muted-foreground mb-4">
            The topic &quot;{topicName}&quot; doesn&apos;t exist or is not
            available.
          </p>
          <Button asChild>
    ...
    <div className="mx-auto max-w-7xl px-4 py-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {displayResources === undefined ? (
          ...
          isInitialLoad ||
          (previousResources && previousResources.length > 0) ? (
            Array.from({ length: 6 }, (_, i) => (
              <ResourceCardSkeleton key={i} />
            ))
          ) : (
