...
export default function TestCodeBlocks() {
  return (
    <div className="mx-auto max-w-3xl space-y-8 p-8">
      <h1 className="mb-8 text-3xl font-bold">Code Block Test Page</h1>

      <section>
        <h2 className="mb-4 text-2xl font-semibold">Inline Code</h2>
        <p>
      ...
      <section>
        <h2 className="mb-4 text-2xl font-semibold">JavaScript Code Block</h2>
...
const greet = (name) => {
  return \`Hello, \${name}!\`;
      ...
      <section>
        <h2 className="mb-4 text-2xl font-semibold">Python Code Block</h2>
...
print(f"Normalized: {processor.normalize()}")`}</CodeBlock>
      ...
      <section>
        <h2 className="mb-4 text-2xl font-semibold">CSS Code Block</h2>
...
@keyframes fadeIn {
  ...
  to { opacity: 1; }
      ...
      <section>
        <h2 className="mb-4 text-2xl font-semibold">HTML Code Block</h2>
