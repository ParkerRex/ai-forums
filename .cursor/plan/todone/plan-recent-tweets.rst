I need help planning a new feature for fetching recent tweets from influential AI people. 

We'll use the following RapidAPI endpoint to get tweets by screen name. 

``` javascript
const url = 'https://twitter-v24.p.rapidapi.com/user/tweets?username=elonmusk&limit=40';
const options = {
	method: 'GET',
	headers: {
		'x-rapidapi-key': 'c2a8df91a3msha281bd0f5191d02p1aed62jsnd2a3b95182a5',
...
We'll fetch the tweets 2x a day, once at 12:00 AM and once at 12:00 PM. 

It'll be for the following people, and each will have a logo next to their name in the front end component to show the brand that they represent.
1. @OfficialLoganK (from google)
Logo here: 
``` svg
...
```
2. @ryolu_ ( from cursor )
logo here: public/cursor-logo.jpg

3. @ericzakariasson ( from cursor )
logo here: public/cursor-logo.jpg
