...
export const paywallCopy: Record<PaywallVariant, PaywallCopy> = {
  default: {
    ...
    trustSignals: ["Cancel in one click", "30-day money-back guarantee", "Join 100+ engineers"],
  ...
  developer: {
    ...
    trustSignals: ["No tracking pixels", "Open source friendly", "DELETE subscription anytime"],
...
export const successCopy: Record<PaywallVariant, SuccessCopy> = {
  default: {
    ...
    welcome: (name) =>
      name ? `We're excited to have you, ${name}!` : "We're excited to have you!",
  ...
  humorous: {
    ...
    welcome: (name) =>
      name ? `But seriously ${name}, welcome aboard!` : "But seriously, welcome aboard!",
  ...
  transparent: {
    ...
    welcome: (name) =>
      name ? `Welcome ${name}. Here's what happens next:` : "Welcome. Here's what happens next:",
  ...
  social: {
    ...
    welcome: (name) =>
      name
        ? `${name}, you're now part of something special.`
  ...
  developer: {
    ...
    welcome: (name) =>
      name ? `User ${name} successfully authenticated.` : "User successfully authenticated.",
