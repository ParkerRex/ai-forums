...
const badgeVariants = cva(
  "inline-flex items-center rounded-none border px-2.5 py-0.5 text-xs font-mono font-semibold uppercase tracking-wide transition-colors focus:outline-hidden select-none",
  {
    variants: {
      variant: {
