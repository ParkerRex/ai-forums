  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100">Roadmap</h3>
        ...
        <div className="space-y-1">
          {visibleIssues.map((issue) => (
            <a
              ...
              className="block text-xs py-1 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 transition-colors"
            >
              {issue.title}
            </a>
          ))}
