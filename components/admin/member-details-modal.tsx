...
export function MemberDetailsModal({ memberId, onClose }: MemberDetailsModalProps) {
  const { data: memberDetails, isLoading } = useAdminMemberDetails(memberId);
              ...
              <div className="rounded-none bg-gray-50 p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-mono text-sm">{member.id || member._id}</p>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {activity.posts.map((post) => (
                      <div key={post._id || post.id} className="rounded-none bg-gray-50 p-3">
                        <div className="flex items-start justify-between">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {activity.comments.map((comment) => (
                      <div key={comment._id || comment.id} className="rounded-none bg-gray-50 p-3">
