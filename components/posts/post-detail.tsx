...
import { usePinPost, useUnpinPost, useUserVote, useVoteOnPost } from "@/hooks/use-posts";
...
export default function PostDetail({
  ...
  const isMemberPost = currentMember && post.member && currentMember.id === post.member?.id;
  ...
  console.log("Debug member check:", {
    ...
    postMember: post.member ? { id: post.member?.id, username: post.member?.username } : null,
    isMemberPost,
  });
