...
async function main() {
  const comments = [
    ...
    {
      content:
        "I just made my account, would it still pass the credits or did i have to have the account before hand created?",
    ...
    {
      content:
        "Welcome Jonathan! I have a photography background myself. Would love to learn more about the stuff you are working on",
    ...
    {
      content:
        "UPDATED LINK: [https://riverside.fm/studio/parker-rexs-studio?t=ce9a566d9674a95e9d15](https://riverside.fm/studio/parker-rexs-studio?t=ce9a566d9674a95e9d15)",
    ...
    {
      content:
        "If youre curious to learn more about how Claude Code works, read here: [https://southbridge-research.notion.site/Architecture-The-Engine-Room-2055fec70db18192963cd6b3a5326476](https://southbridge-research.notion.site/Architecture-The-Engine-Room-2055fec70db18192963cd6b3a5326476)",
    ...
    {
      content:
        "[https://support.anthropic.com/en/articles/11014257-about-claude-s-max-plan-usage](https://support.anthropic.com/en/articles/11014257-about-claude-s-max-plan-usage)",
    ...
    {
      content:
        "Thanks, @Parker Rex for your effort. Not that it's a deal breaker, but do the credits apply if you're still within the 14 day trial. Thanks!",
    ...
    {
      content:
        "Sounds really interesting. I am in the drone industry, photogrammetry and lidar for surveying purposes mostly.",
    ...
    {
      content:
        "@Josh Coleman - Love the Augment Planning + CC execution workflow. Will you keep paying for both ongoing, or free plan for Augment?",
    ...
    {
      content:
        "I was able to login but am guessing the notice you will send will be where we can update our CC information to continue to be a member of this community @Parker Rex ?",
    ...
    {
      content:
        "[https://x.com/amir/status/1940112288381641026](https://x.com/amir/status/1940112288381641026)",
    ...
    {
      content:
        "update on this -- 11 tickets squashed. still grinding. if you go signup it should all work :)",
    ...
    {
      content:
        "@Parker Rex thanks much. I can't see mine either (developer@helpsmin.com). Do I need to start a free trial account first before I can see it?",
    ...
    {
      content:
        'Thanks! Hell yeah, I\'m excited to be doing something that I enjoy and hoping pursuing this hobby alongside like-minded people can become more for us all! "A rising tide lifts all boats"',
    ...
    {
      content:
        "Where can we see the credits? I don't think I received them as I am using [orakemu@gmail.com](mailto:orakemu@gmail.com) and not [yorgohoebeke@gmail.com](mailto:yorgohoebeke@gmail.com)",
